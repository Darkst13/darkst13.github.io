...
<br>
  ...
  <div class="login-box">
  <h2>magicsaetch</h2>
  <form method="post" action="/english-arabic/" target="_blank">
    <div class="user-box">
      <input name="q" type="text" value="ابحث عن كلمة انجليزية..." data-default="ابحث عن كلمة انجليزية..." onfocus="if(this.value==this.getAttribute('data-default')){this.value=''}" onblur="if(this.value==''){this.value=this.getAttribute('data-default')}">
    </div>
    <input class="btn btn-effect">
      <span></span>
      <span></span>
      <span></span>
      <span></span>
