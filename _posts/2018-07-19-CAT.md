...
<form method="post" action="/english-arabic/" style="text-align:left;line-height:1.15;padding:10px;border:solid 1px #e2ded6;background:#fff;width:278px" target="_blank">
<input type="text" style="width:100%" name="q" value="Translate from English to Arabic here..." data-default="Translate from English to Arabic here..." onfocus="if(this.value==this.getAttribute('data-default')){this.value=''}" onblur="if(this.value==''){this.value=this.getAttribute('data-default')}">
<br>
